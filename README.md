...
This is my 6th Fend Project. The goal was to turn a given webpage into a mobile friendly one, add accessibility features and use a service worker to cache the site for offline usage.
